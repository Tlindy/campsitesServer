...
// Route for all favorites- /favorites
favoriteRouter
    .route("/")
            ...
            .then(favorite => {
                ...
                if (favorite) {
                    req.body.forEach(fav => {
                        //check to see if the favorite is in the array of campsites
...
//Route for an individual favorite campsite- /favorites/:campsiteId
favoriteRouter
    .route("/:campsiteId")
    .options(cors.corsWithOptions, (req, res) => res.sendStatus(200))
    .get(cors.cors, authenticate.verifyUser, (req, res, next) => {
