...
// Route for all the campsites- /campsites
campsiteRouter
    .route("/")
    .get((req, res, next) => {
        Campsite.find()
...
// Route for an individual campsite- /campsites/:campsiteId
campsiteRouter
    .route("/:campsiteId")
    .get((req, res, next) => {
...
// Route for individual comment- /campsites/:campsiteId/comments/:commentId
campsiteRouter
